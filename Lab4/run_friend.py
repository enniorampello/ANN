...
if __name__ == "__main__":
    ...
    '''
    err_1, err_2, err_3 = dbn.train_greedylayerwise(vis_trainset=train_imgs, lbl_trainset=train_lbls, n_iterations=20)
    plt.plot(err_1)
    plt.plot(err_2)
    plt.plot(err_3)
    plt.legend(['vis--hid','hid--pen','pen+lbl--top'])
    plt.title('reconstruction error for three layers')
    plt.show()
    '''
