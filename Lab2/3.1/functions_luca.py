    ...
    for epoch in range(max_epochs):
        ...
        if ES:
            ...
            if patience_counter >= patience:
                ...
                return w, train_errors, val_errors, epoch
...
def plot(patterns, targets, preds, lr, num_nodes, max_epochs,
         ...
         centroids=None, test=False, validation=False, centroids_init=None, competitive=False):
    ...
    if import_data:
        ...
        if validation == False and test == False:
            plt.scatter(centroids_init, np.zeros(centroids_init.shape), marker='x', c='r', label="initial centroids")
            if competitive:
                plt.scatter(centroids, np.zeros(centroids.shape), marker='x', c='black', label="updated centroids")
